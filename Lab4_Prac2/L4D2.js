...
function render() {
   ...
   //draw cube
   var cubeTF = mv;
   cubeTF = mult(cubeTF, cubeRot);   
   cubeTF = mult(cubeTF, translate(2, 0, 0));
   cubeTF = mult(cubeTF, scale(.2,.2, .2));
   gl.uniform1i(lighting, 0);
   gl.uniform4fv(light.position, mult(cubeTF, lpos));
